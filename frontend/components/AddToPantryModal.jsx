            ...
            {scannedIngredients.length === 0 ? (
              ...
              <div className="space-y-4">
                ...
                {selectedImage && !scanning && (
                  <Button
                    onClick={handleScan}
                    className="w-full bg-gold-400 hover:bg-gold-500 text-gold-900 h-12 text-lg"
                    disabled={scanning}
                  >
                    {scanning ? (
                      <>
              ...
              <div className="space-y-4">
                  ...
                  {scannedIngredients.map((ingredient, index) => (
                    ...
                    >
                      ...
                      {ingredient.confidence && (
                        <Badge
                          variant="outline"
                          className="text-xs text-emerald-600 dark:text-emerald-400 border-emerald-300 dark:border-emerald-700"
                        >
                ...
                <Button
                  ...
                  className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white h-12 w-full"
                >
                  {saving ? (
                    <>
                      <Loader2 className="w-5 h-5 mr-2 animate-spin" />
            ...
            <form onSubmit={handleAddManual} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-border bg-background rounded-xl focus:outline-none focus:ring-2 focus:ring-gold-400 text-foreground"
                  disabled={adding}
                />
              </div>
              ...
              <Button
                type="submit"
                disabled={adding}
                className="flex-1 bg-gold-400 hover:bg-gold-500 text-gold-900 h-12 w-full"
              >
                {adding ? (
                  <>
                    <Loader2 className="w-5 h-5 mr-2 animate-spin" />
