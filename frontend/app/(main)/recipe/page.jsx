...
function RecipeContent() {
    ...
    return (
      <div className="min-h-screen bg-background pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-4xl text-center py-20">
          ...
          <Link href="/dashboard">
            <Button className="bg-gold-400 hover:bg-gold-500">
              Go to Dashboard
            </Button>
          </Link>
        </div>
      ...
      <div className="min-h-screen bg-background pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center py-20">
            <ClockLoader className="mx-auto mb-6" color="#d4af37" />
            <h2 className="text-3xl font-bold text-foreground mb-2 tracking-tight">
              Preparing Your Recipe
            </h2>
            <p className="text-muted-foreground font-light">
              Our AI chef is crafting detailed instructions for{" "}
              <span className="font-bold text-gold-400">{recipeName}</span>
              ...
            </p>
            <div className="mt-8 max-w-md mx-auto">
              <div className="flex items-center gap-3 text-sm text-muted-foreground">
                <div className="flex-1 h-1 bg-muted overflow-hidden relative">
                  <div className="absolute left-0 top-0 h-full bg-gold-400 animate-slow-fill" />
                </div>
              </div>
            </div>
          </div>
  ...
  if (loadingRecipe === false && !recipe) {
    return (
      <div className="min-h-screen bg-background pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-4xl text-center py-20">
          <div className="bg-red-50 dark:bg-red-900/20 w-20 h-20 border-2 border-red-200 dark:border-red-800 flex items-center justify-center mx-auto mb-6">
          ...
          <div className="flex gap-3 justify-center">
            <Button
              onClick={() => router.back()}
              variant="outline"
              className="border-2 border-foreground/20 hover:bg-foreground hover:text-background"
            >
    ...
    <div className="min-h-screen bg-background pt-24 pb-16 px-4">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="mb-8">
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-2 text-muted-foreground hover:text-gold-400 transition-colors mb-6 font-medium"
          >
          ...
          <div className="bg-card p-8 md:p-10 border-2 border-border mb-6">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <Badge
                variant="outline"
                className="text-gold-400 border-2 border-gold-400/30 capitalize"
              >
                {recipe.cuisine}
              </Badge>
              <Badge
            ...
            <div className="flex flex-wrap gap-3">
              <Button
                ...
                className={`${
                  isSaved
                    ...
                    : "bg-gold-400 hover:bg-gold-500 border-2 border-gold-500"
              ...
              >
                {({ loading }) => (
                  <Button
                    variant="outline"
                    className="border-2 border-gold-400/50 text-gold-600 dark:text-gold-400 hover:bg-gold-50 dark:hover:bg-gold-900/20 gap-2"
                    disabled={loading}
                  >
        ...
        <div className="grid lg:grid-cols-3 gap-6">
                ...
                <div key={category} className="mb-6 last:mb-0">
                  ...
                  <ul className="space-y-2">
                    {items.map((ingredient, i) => (
                      <li
                        key={i}
                        className="flex justify-between items-start gap-2 text-foreground/80 py-2 border-b border-border last:border-0"
                      >
                        <span className="flex-1">{ingredient.item}</span>
                        <span className="font-bold text-gold-400 text-sm whitespace-nowrap">
                          {ingredient.amount}
                        </span>
                      </li>
                    ))}
              ...
              {recipe.nutrition && (
                <div className="mt-6 pt-6 border-t-2 border-border">
                  <h3 className="font-bold text-foreground mb-3 uppercase tracking-wide text-sm flex items-center gap-2">
                    ...
                    {!recipeData.isPro && (
                      <span className="text-xs bg-gold-100 dark:bg-gold-900/30 text-gold-600 dark:text-gold-400 px-2 py-0.5 rounded-full font-semibold">
                        PRO
                      </span>
                    )}
                  </h3>
                  ...
                  >
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-gold-50 dark:bg-gold-900/20 p-3 text-center border-2 border-gold-400/20">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-card p-8 border-2 border-border">
                  ...
                  <div
                    ...
                    className={`relative pl-12 pb-8 ${
                      index !== recipe.instructions.length - 1
                        ? "border-l-2 border-gold-300 dark:border-gold-700 ml-5"
                        : "ml-5"
                    }`}
                  >
                    {/* Step Number */}
                    <div className="absolute -left-5 top-0 w-10 h-10 bg-gold-400 text-white flex items-center justify-center font-bold border-2 border-gold-500">
                      {step.step}
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-foreground/80 font-light mb-3">
                        {step.instruction}
                      </p>
                      {step.tip && (
                        <div className="bg-gold-50 dark:bg-gold-900/20 border-l-4 border-gold-400 p-4">
                          <p className="text-sm text-gold-900 dark:text-gold-200 flex items-start gap-2">
                            <Lightbulb className="w-4 h-4 mt-0.5 flex-shrink-0 fill-gold-400" />
                            <span>
              ...
              {/* Completion Message */}
              <div className="mt-8 p-6 bg-gradient-to-br from-emerald-50 dark:from-emerald-950/30 to-emerald-50 dark:to-emerald-950/20 border-2 border-emerald-200 dark:border-emerald-800">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-emerald-800 dark:text-emerald-300 font-light">
            ...
            {recipe.tips && recipe.tips.length > 0 && (
              <div className="bg-gradient-to-br from-gold-50 dark:from-gold-950/20 to-gold-100 dark:to-gold-950/10 p-8 border-2 border-gold-400/30">
                <h2 className="text-2xl font-bold text-foreground mb-4 flex items-center gap-2">
                  <Lightbulb className="w-6 h-6 text-gold-400 fill-gold-400" />
                  Chef&apos;s Tips & Tricks
                  {!recipeData.isPro && (
                    <span className="text-xs bg-gold-100 dark:bg-gold-900/30 text-gold-600 dark:text-gold-400 px-2 py-0.5 rounded-full font-semibold">
                      PRO
